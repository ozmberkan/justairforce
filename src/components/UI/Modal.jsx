      ...
      >
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h3 className="text-3xl font-bold text-center mb-2">Bir dakika!</h3>
            <p className="text-center mb-6">
              Bu uygulama, hala geliştirme aşamasında. Bu yüzden bazı hatalar ve
              eksiklikler olabilir. Anlayışınız için teşekkür ederim.
            </p>
